...
<div class="dokan-product-inventory dokan-edit-row <?php echo esc_attr( $class ); ?>">
    ...
    <div class="dokan-section-content">
        ...
        <div class="dokan-form-group hide_if_grouped hide_if_external">
            <?php dokan_post_input_box( $post_id, '_manage_stock', array( 'label' => __( 'Enable product -Hello- stock management', 'dokan-lite' ) ), 'checkbox' ); ?>
        </div>
        ...
        <div class="show_if_stock dokan-stock-management-wrapper dokan-form-group dokan-clearfix">
            ...
            <div class="content-half-part">
                ...
                <?php $cs_stock = wc_stock_amount( $_stock ); ?>
                <input type="number" class="dokan-form-control" name="_stock" placeholder="<?php esc_attr__( '1', 'dokan-lite' ); ?>" value="<?php echo esc_attr( $cs_stock > 0 ? $cs_stock : 10 ); ?>" min="0" step="1">
            </div>
